        ...
        <div class="widget">
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              @foreach( $bestseller as $bl)
                  <div class="media beta-sales-item">
                              <a href="detail/{{$bl->id}}"><img src="/source/image/product/{{$bl->image}}" alt=""></a>			
                      <div class="media-body">
                          {{$bl->name }}
                          <span class="beta-sales-price">${{ number_format($bl->unit_price) }} Dong</span>
                      </div>
                  </div>
              @endforeach
            </div>
          ...
          <div class="widget-body">
            <div class="media beta-sales-item">
              @foreach( $new_product as $prd)
                <div class="media beta-sales-item">
                      <a class="pull-left" href="detail/{{$prd->id}}"><img src="/source/image/product/{{$prd->image}}" alt=""></a>			
                  <div class="media-body">
                    {{$prd->name }}
                    <span class="beta-sales-price">${{ number_format($prd->unit_price, 2) }}</span>
                  </div>
                </div>
              @endforeach																												
            </div>	
